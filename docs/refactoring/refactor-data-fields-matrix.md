...
| Matrix | `Cyberbuchse` | Aktive Cyberbuchse kann `Datenverarbeitung`, `Firewall` und VR-Initiativebonuswuerfel liefern | `sr6_matrix_cyberbuchse_aktiv`, `sr6_matrix_cyberbuchse_datenverarbeitung`, `sr6_matrix_cyberbuchse_firewall`, `sr6_matrix_cyberbuchse_initiative_w6` | Nur bei aktiver Cyberbuchse werden D/F in die aktiven Matrixwerte uebernommen; Angriff/Schleicher bleiben manuell |
| Matrix | `Overwatch` | Manuell gefuehrter Overwatch-Wert | `sr6_matrix_overwatch` | Kein Standard-Wuerfelpool |
| Matrix | `Matrix-Initiative` | AR: `Reaktion + Intuition + 1W6`; VR: `Datenverarbeitung + Intuition + 2W6/3W6`, bei aktiver Cyberbuchse plus VR-Bonuswuerfel | `sr6_matrix_modus`, `sr6_matrix_datenverarbeitung`, `sr6_matrix_cyberbuchse_initiative_w6`, Attribute `Reaktion`, `Intuition` | Cyberbuchsenbonus gilt nur in VR |
